...
Java_com_hryt_nativeaudio_MainActivity_createEngine(JNIEnv* env, jclass clazz)
{
    SLresult result;
...
JNIEXPORT void JNICALL
Java_com_hryt_nativeaudio_MainActivity_createBufferQueueAudioPlayer(JNIEnv* env,
...
Java_com_hryt_nativeaudio_MainActivity_createUriAudioPlayer(JNIEnv* env, jclass clazz,
        jstring uri)
{
    SLresult result;
...
JNIEXPORT void JNICALL
Java_com_hryt_nativeaudio_MainActivity_setPlayingUriAudioPlayer(JNIEnv* env,
...
JNIEXPORT void JNICALL
Java_com_hryt_nativeaudio_MainActivity_setLoopingUriAudioPlayer(JNIEnv* env,
...
JNIEXPORT void JNICALL
Java_com_hryt_nativeaudio_MainActivity_setChannelMuteUriAudioPlayer(JNIEnv* env,
...
JNIEXPORT void JNICALL
Java_com_hryt_nativeaudio_MainActivity_setChannelSoloUriAudioPlayer(JNIEnv* env,
...
Java_com_hryt_nativeaudio_MainActivity_getNumChannelsUriAudioPlayer(JNIEnv* env, jclass clazz)
{
    SLuint8 numChannels;
    SLresult result;
    SLMuteSoloItf muteSoloItf = getMuteSolo();
...
JNIEXPORT void JNICALL
Java_com_hryt_nativeaudio_MainActivity_setVolumeUriAudioPlayer(JNIEnv* env, jclass clazz,
        jint millibel)
{
    SLresult result;
...
JNIEXPORT void JNICALL
Java_com_hryt_nativeaudio_MainActivity_setMuteUriAudioPlayer(JNIEnv* env, jclass clazz,
        jboolean mute)
{
    SLresult result;
    SLVolumeItf volumeItf = getVolume();
...
JNIEXPORT void JNICALL
Java_com_hryt_nativeaudio_MainActivity_enableStereoPositionUriAudioPlayer(JNIEnv* env,
...
JNIEXPORT void JNICALL
Java_com_hryt_nativeaudio_MainActivity_setStereoPositionUriAudioPlayer(JNIEnv* env,
...
JNIEXPORT jboolean JNICALL
Java_com_hryt_nativeaudio_MainActivity_enableReverb(JNIEnv* env, jclass clazz,
        jboolean enabled)
{
    SLresult result;
...
JNIEXPORT jboolean JNICALL
Java_com_hryt_nativeaudio_MainActivity_selectClip(JNIEnv* env, jclass clazz, jint which,
        jint count)
{
...
JNIEXPORT jboolean JNICALL
Java_com_hryt_nativeaudio_MainActivity_createAssetAudioPlayer(JNIEnv* env, jclass clazz,
...
JNIEXPORT void JNICALL
Java_com_hryt_nativeaudio_MainActivity_setPlayingAssetAudioPlayer(JNIEnv* env,
        jclass clazz, jboolean isPlaying)
{
    SLresult result;
...
JNIEXPORT jboolean JNICALL
Java_com_hryt_nativeaudio_MainActivity_createAudioRecorder(JNIEnv* env, jclass clazz)
{
    SLresult result;
...
JNIEXPORT void JNICALL
Java_com_hryt_nativeaudio_MainActivity_startRecording(JNIEnv* env, jclass clazz)
{
    SLresult result;
...
JNIEXPORT void JNICALL
Java_com_hryt_nativeaudio_MainActivity_shutdown(JNIEnv* env, jclass clazz)
{
